...
- Existing functions generalized: None.
- New functions added: `solubility_complete_check`, to expose the required-versus-maximum decision and residual undissolved mass for Q18-style common-ion tasks.
...
- Tests added: `December2025ReuseTests` checks Q15-Q16, Q18-Q20 and Q23-Q26, including complete-dissolution decisions for AgBr/CuBr with common bromide.
- Unresolved issues: None.
- Exam set complete: `yes`
