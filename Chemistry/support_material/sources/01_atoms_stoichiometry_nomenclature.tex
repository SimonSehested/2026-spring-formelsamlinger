...
\pythontool{\texttt{molar\_mass("Ca(OH)2")} for formulaer med parenteser, hydrater eller gentagne molarmasser; brug resultatet direkte i masseprocentformlen}
...
\pythontool{\texttt{molar\_mass(...)} til at kontrollere empirisk-formel- og molekylformel-masser, naar formlen er fundet}
...
\pythontool{\texttt{molar\_mass(...)} for alle masse-til-mol og mol-til-masse trin i stoikiometri med sammensatte formler}
