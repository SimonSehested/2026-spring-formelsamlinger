...
\pythontool{\texttt{equilibrium\_constant(...)} efter \(\Delta G^\circ=-nFE^\circ\) er beregnet, eller \texttt{constant("F")} ved manuel \(\Delta G^\circ\)-beregning}
...
\pythontool{\texttt{equilibrium\_constant(...)} efter \(E^\circ\rightarrow\Delta G^\circ\); brug \texttt{constant("F")} og \texttt{constant("R")} til manuel kontrol}
...
\pythontool{\texttt{cell\_potential(...)} for Nernst-beregninger og koncentrationsceller, isaer naar \(T\neq298\,\mathrm K\)}
