...
\pythontool{\texttt{weak\_solution\_ph(...)} med \texttt{"acid"} eller \texttt{"base"} naar 5\%-testen fejler eller pH skal kontrolleres hurtigt}
...
\pythontool{\texttt{solubility\_from\_ksp(...)} til molar solubility med stoikiometri og common ion; brug \texttt{solubility\_complete\_check(...)} naar en tilsat saltmasse skal vurderes som helt opløst eller i overskud}
