...
\pythontool{\texttt{molar\_mass(...)} naar den givne saltmasse foerst skal omregnes til stofmaengde}
...
\pythontool{\texttt{molar\_mass(...)} for praecipitatets molarmasse, isaer ved salte med parenteser eller tunge ioner}
...
\pythontool{\texttt{ideal\_gas(...)} til at finde gasmol eller den manglende \(p,V,n,T\), og \texttt{molar\_mass(...)} til empirisk- og molekylformelmassen}
...
\pythontool{\texttt{ideal\_gas(...)} naar en af \(p,V,n,T\) mangler eller naar gas tilfoejes, fjernes eller forbruges}
...
\pythontool{\texttt{ideal\_gas(...)} til gasmol/tryk efter reaktion og \texttt{molar\_mass(...)} til produkt- eller reaktantmasser}
...
\pythontool{\texttt{molar\_mass(...)} naar effusionssammenligningen kraever molarmasser fra kemiske formler}
