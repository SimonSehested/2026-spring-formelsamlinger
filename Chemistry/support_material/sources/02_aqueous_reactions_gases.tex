...
\textbf{Required references:} Half-reaction procedure \eqref{eq:aqueous:redox-half-reaction-sequence}.

\textbf{Steps:}
\begin{enumerate}
    \item Separate oxidation and reduction half-reactions by identifying which oxidation states increase and decrease.
