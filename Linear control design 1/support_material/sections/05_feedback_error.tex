...
\item Hvis \(L(s)\) har \(n\) rene integratorer, er systemtypen \(n\). I stabil unity
      feedback giver type 0 typisk endelig stepfejl, type 1 nul stepfejl for step og
      endelig fejl for ramp.
\end{enumerate}
...
\(\infty\). En type-1 unity-feedback loop har derfor nul stepfejl, endelig rampfejl og
uendelig parabolic-fejl.
