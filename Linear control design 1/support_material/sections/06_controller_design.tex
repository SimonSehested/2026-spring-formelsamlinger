...
\paragraph{Python}
\code{design\_pi\_lead(num,den,omega\_c,phase\_margin\_deg,n\_i,tau\_i,alpha,tau\_d,Kp)}
bruges, når PI-Lead-strukturen er valgt, men opgaven kan give forskellige kendte
størrelser. Funktionen kan designe de manglende parametre eller checke en foreslået
regulator og returnerer targetchecks, faktisk crossover, phase margin, gain margin og
warnings. \code{design\_pi\_lead\_at\_crossover(num,den,omega\_c,phase\_margin\_deg,n\_i)}
er den gamle wrapper til klassisk design med \(N_i\). Vælg ikke controllerstruktur eller
crossover blindt ud fra outputtet.
